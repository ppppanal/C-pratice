...
char tempDate[] = "",tempST[]="",tempET[]="",tempTypeSelect[]="";
        ...
        if (ErrorTime == 3)
        {
         ...
         //check time conflict
            ...
            if (Error == false && TimeConflict == false) {
                ...
                if (YYYY[record] % 4 == 0 && MM[record] > 2) {
                    total_stmin[record] += 60 * 24;
                }
...
void R41() 
{
    ...
    for (int i = 0; i < record; i++) {
        ...
        //Title and Type 
        //                     Title      
        cout<<left<<setw(45)<<title[i] ;
        switch (Type[i]) {
        case 1:cout << "Home"; break;
        case 2:cout << "Work"; break;
        case 3:cout << "Study"; break;
        case 4:cout << "Play"; break;
        }
        cout << endl;
    }
    cout << endl << endl;
